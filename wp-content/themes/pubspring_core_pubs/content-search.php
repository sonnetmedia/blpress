...
<style>
.results-box{width: 30%;margin-right: 1%;
	margin-bottom: 6%;background-color: #f0eee9;float: left;
			
}
</style>
	<div class="results-box shadow-light">  
		<div style="padding: 1em;">
	      
	
	    <?php if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it. ?>
		    		<a href="<?php the_permalink(); ?>">
	    				<?php the_post_thumbnail('category-thumb', array('class' => 'image-shadow centered flow_left')); ?>
	    			</a>
