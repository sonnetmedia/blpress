...
function pubspring_setup() {
	...
	add_theme_support( 'post-thumbnails', array( 'post', 'page', 'product' , 'sm_authors', 'sm_contributor', 'sm_articles') );
	...
	add_image_size( 'category-large', 950, 9999 ); 	//900 pixels wide (and unlimited height)
	add_image_size( 'book-cover-small', 160, 240 ); 	//900 pixels wide (and unlimited height)
	add_image_size( 'book-cover-medium', 260, 390 ); 	//900 pixels wide (and unlimited height)
	add_image_size( 'book-cover-large', 460, 690 ); 	//900 pixels wide (and unlimited height)	
