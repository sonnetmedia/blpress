...
function setup_theme_admin_menus() {
    add_menu_page('PubSpring Settings', 'PubSpring', 'edit_pages',
        'pubspring_settings', 'pubspring_settings_page','http://pubspring.us/static/pubspring_logo-16x.png');
...
add_settings_field(
	'sm_client_info',
	'Info or About Stmt',
	'pubspring_client_info_callback',
	'pubspring_social_accounts',
	'social_settings_section',
	array(
		'Input a short statement here.'
	)
);
...
function pubspring_client_address_callback($args) {
	$html = '<textarea rows="4" cols="50" id="sm_client_address" name="sm_client_address">'. get_option('sm_client_address') .'</textarea>';
	$html .= '<label for="sm_client_address"> '  . $args[0] . '</label>';
	echo $html;
} // end pubspring_toggle_footer_callback

function pubspring_client_info_callback($args) {
	$html = '<textarea rows="4" cols="50" id="sm_client_info" name="sm_client_info">'. get_option('sm_client_info') .'</textarea>';
	$html .= '<label for="sm_client_info"> '  . $args[0] . '</label>';
	echo $html;
} // end pubspring_toggle_footer_callback
