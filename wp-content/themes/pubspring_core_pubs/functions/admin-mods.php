...
function hide_admin_menu()
{
	...
	if($current_user->user_login != 'admin' )
	{
		...
		#toplevel_page_pb_backupbuddy_getting_started,
...
remove_menu_page('index.php?page=woothemes-plugin-updater'); // Pages
...
add_menu_page('Site Stats', 'Site Stats', 'edit_posts', 'stats', '', '', 0); 
...
function sm_rss_output(){
    echo '<div class="rss-widget">';
       ...
       wp_widget_rss_output(array(
            'url' => 'http://pubspring.us/feed',  //put your feed URL here
