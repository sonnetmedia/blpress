...
<img src="/wp-content/themes/pubspring_pubs_core/images/icons/goodreads_icon_32x32-1e528ef775d77128b4395d344cbc7f8d.png" alt="" />
</a>
<?php } if($sm_library_thing) {    ?>
<a href="http://www.librarything.com/author/<?php echo $sm_library_thing; ?>"  class="at300b" target="_blank" > 
<img src="/wp-content/themes/pubspring_pubs_core/images/icons/librarything40.png" style="height: 32px;" alt="" />
</a>
<?php } echo '</div>'; ?>
